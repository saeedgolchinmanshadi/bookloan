...
final class BookController extends AbstractController
{
    ...
    public function index(Request $request, BookRepository $bookRepository, PaginatorInterface $paginator): Response
    {
        ...
        $pagination = $paginator->paginate(
            $bookRepository->createSearchQueryBuilder($searchQuery),
    ...
    #[Route('/{id<\d+>}', name: 'app_book_delete', methods: ['POST'])]
    public function delete(Request $request, Book $book, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValidOrFlash('delete' . $book->getId(), $request)) {
